...
export default function Travel({ navigation }) {
    ...
    const travelExpenseIds = getExpenseIdsByCategory(expenses, expenseCategories.KULKEMINEN);
        ...
        <StoreProvider store={store}>
            <View style={styles.container}>
                ...
                <View style={styles.rectangle}>
                    <Text style={styles.welcomeText}>Kulkeminen</Text>
                    <View style={styles.divider} />
                    <Text style={styles.infoText}>
                        Lisää tähän kaikki matkakulusi{'\n'}
                    </Text>
                    <View style={styles.rowContainer}>
                        <ScrollView>
                            {
                                _.map(travelExpenseIds, id => {
